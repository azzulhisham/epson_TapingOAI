...
Public Class frm_Main
                ...
                Case SysAppMode.app_Auto
                    If .SysData(0).LotNo = "" Then
                        ...
                        If .SysData(0).LotNo <> "" Then
                            ...
                            'Set Filter Size : 5x5
                            Me.FZ_SerCmd("UNITDATA 15 123 1")
    ...
    Private Function SetInspChr(ByVal InspData As String, ByVal ProgNo As String) As Integer
        ...
        For iLp As Integer = 140 To 175
            ...
            If Not InspData.IndexOf(InspChar.Substring(iLp - 140, 1)) < 0 Then
                                ...
                                If ChkDataFmt < 0 Then
                                    ...
                                    If FmtRetry > 7 Then
                                        ...
                                        If Not Val(FilterSize(0)) = Val(.BGSmaxSet) Then
                                            Me.FZ_SerCmd("UNITDATA 15 123 1", RetVal)
                                    ...
                                    Else
                                        If Data.GetUpperBound(0) < 2 OrElse (Data(1) <> "" Or Data(2) <> "") Then
                                            ...
                                            Me.FZ_SerCmd("UNITDATA 15 123", RetVal)
                                            Dim FilterSize() As String = RetVal.Split(" "c)
    ...
    Private Sub btn_AdvanceSet_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_AdvanceSet.Click
