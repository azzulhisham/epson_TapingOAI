...
Namespace My
    ...
    Partial Friend Class MyApplication
        ...
        Private Sub MyApplication_Startup(ByVal sender As Object, ByVal e As Microsoft.VisualBasic.ApplicationServices.StartupEventArgs) Handles Me.Startup
            ...
            If frm_Splash.IsHandleCreated = True Then End
            AutoStartShortCut()
        ...
        Private Sub MyApplication_UnhandledException(ByVal sender As Object, ByVal e As Microsoft.VisualBasic.ApplicationServices.UnhandledExceptionEventArgs) Handles Me.UnhandledException
            ...
            'Tp_OAI.Mode = frm_Main.TabControl1.SelectedIndex

            If frm_Main.TabControl1.InvokeRequired Then
                Tp_OAI.Mode = SysAppMode.app_Auto
            Else
                Tp_OAI.Mode = frm_Main.TabControl1.SelectedIndex
            End If

            MessageBox.Show(e.Exception.Message & vbCrLf & "Please call youe system engineer to resolve the issue.", "Taping OAI - System Crash !", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
