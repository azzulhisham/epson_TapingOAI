Public Class frm_DataEntry
    ...
    Dim TapingLotFormDataList As List(Of TapingLotFormData) = Nothing
    ...
    Private Sub frm_DataEntry_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        With Me
            .TapingLotFormDataList = New List(Of TapingLotFormData)
                ...
                Select Case LE_SeqNo
                        ...
                        If iChk = 0 Then
                            If strData.IndexOf("/.") = 0 Then
                                ...
                                Else
                                    ...
                                    Me.TapingLotFormDataList = GetExternalSourceData(.SysData(1).LotNo)
                    ...
                    Case Is = 2
                        ...
                        If iChk = 0 Then
                            If strData.IndexOf("/.") = 0 Then
                                ...
                                If Not p_LotNo.ToUpper.StartsWith("P") AndAlso Not p_LotNo.ToUpper.StartsWith("E") Then
                    ...
                    Case Is = 3
                        ...
                        If iRecCnt > 0 Then
                            ...
                            Else
                                ...
                                With Tp_OAI
                                    ...
                                    If Not IsNothing(TapingLotFormDataList) And TapingLotFormDataList.Count > 0 Then
                                        iSQLrec = TapingLotFormDataList.Count
                                        ReDim SQLdbRecs(iSQLrec - 1)

                                        For index = 0 To TapingLotFormDataList.Count - 1
                                            For idx = 0 To .SysData(1).P_Lot.Length - 1
                                                If .SysData(1).P_Lot(idx).P_LotNo.Trim = TapingLotFormDataList(index).F_LOTNO.Trim Then
                                                    .SysData(1).P_Lot(idx).QtyUsed = TapingLotFormDataList(index).H_USEDQTY
                                                    .SysData(1).P_Lot(idx).WeekCode = TapingLotFormDataList(index).G_WKCODE.Trim
                                                End If
                                            Next

                                            SQLdbRecs(index).IMI_No = TapingLotFormDataList(index).B_SPEC.Trim
                                            SQLdbRecs(index).MData1 = TapingLotFormDataList(index).C_FREQ.Trim
                                            SQLdbRecs(index).MData2 = TapingLotFormDataList(index).G_WKCODE.Trim
                                        Next
                                    Else
                                    ...
                                    If (iRecCnt < 0 And iSQLrec < 0) Or .SysData(1).P_Lot.Any(Function(q) q.WeekCode = "") Then
                                        'No Rec
                                ...
                                If ChkSpec = 0 Then
                                    ...
                                    If My.Computer.FileSystem.FileExists(MFCSpecFile) Then
                                        ...
                                        End Try
                                    Else
                                        If Not .Ims_SpecNo.IndexOf(.SysData(1).MFCSpec(0).ToUpper.Trim) < 0 Then
                                            Dim Ims_SpecNos() As String = .Ims_SpecNo.Split("|"c)
                                            Dim Ims_SpecNoSelect As String = Ims_SpecNos.FirstOrDefault(Function(n) n.Contains(.SysData(1).MFCSpec(0).ToUpper.Trim))

                                            If Not String.IsNullOrEmpty(Ims_SpecNoSelect) Then
                                                Dim Ims_SceneSelect() As String = Ims_SpecNoSelect.Split(":"c)

                                                .SysData(1).Prod = Ims_SceneSelect(1)
                                                .SysData(0) = .SysData(1)
                        ...
                        Else
                            ...
                            If IsNothing(TapingLotFormDataList) Or TapingLotFormDataList.Count = 0 Then
                            ...
                            If .SysData(1).P_Lot.Any(Function(q) q.WeekCode = "") Then
                                'No Rec
                                If MessageBox.Show("Missing Marking Data!" & vbCrLf & "Anyway, do you wish to re-enter Lot Data?", "Invalid Data...", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.No Then
                                    .SysData(0).GUID = ""
                                    Me.LE_SeqNo = 0
                                    Me.Close()
                                Else
